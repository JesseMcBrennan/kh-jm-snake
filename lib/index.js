...
const keyboard = {
  'key38': () => game.snake.direction !== 'down' ? game.snake.direction = 'up' : game.snake.direction,
  'key40': () => game.snake.direction !== 'up' ? game.snake.direction = 'down' : game.snake.direction,
  'key37': () => game.snake.direction !== 'right' ? game.snake.direction = 'left' : game.snake.direction,
  'key39': () => game.snake.direction !== 'left' ? game.snake.direction = 'right' : game.snake.direction
};
